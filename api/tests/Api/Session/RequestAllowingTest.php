...
class RequestAllowingTest extends WebTestCase
{
    ...
    public function testSessionDuplicateDifferentLocationNotAllowed(): void
    {
        $license = $this->createLicense();
        $requestBody = $this->createValidRequestBody($license->getUuid(), "127.0.0.1");
        ...
        $requestBody = $this->createValidRequestBody($license->getUuid(), "192.168.0.1");
        ...
        $this->assertValidResponse(
            ...
            iv: $requestBody["iv"],
            expectedCode: 409,
            expectedMessage: "This license already has an active session."
        );
    }

    public function testSessionSameLocationUpdate(): void
    {
        $license = $this->createLicense();
        $requestBody = $this->createValidRequestBody($license->getUuid(), "127.0.0.1");
        ...
        $this->assertValidResponse(
            ...
            iv: $requestBody["iv"],
            expectedCode: 201,
            expectedMessage: "Session updated."
        );
    }

    public function testTerminationSessionNotFound(): void
    {
        $license = $this->createLicense();
        $requestBody = $this->createValidRequestBody($license->getUuid(), "127.0.0.1");
